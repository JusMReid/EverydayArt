...
$resultQuestion1 = mysql_query("SELECT * FROM poll WHERE question='1'");
$num_rowsQuestion1 = mysql_num_rows($resultQuestion1);

$resultQuestion2 = mysql_query("SELECT * FROM poll WHERE question='2'");
$num_rowsQuestion2 = mysql_num_rows($resultQuestion2);

$resultQuestion3 = mysql_query("SELECT * FROM poll WHERE question='3'");
$num_rowsQuestion3 = mysql_num_rows($resultQuestion3);

$resultQuestion4 = mysql_query("SELECT * FROM poll WHERE question='4'");
$num_rowsQuestion4 = mysql_num_rows($resultQuestion4);

$resultQuestion5 = mysql_query("SELECT * FROM poll WHERE question='5'");
...
<body>
	<fieldset>
		...
		<ul>
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion1 ?></span> <?php session_start(); echo $_SESSION['p1']; ?>
				<br />
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion2 ?></span> <?php echo $_SESSION['p2']; ?>
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion3 ?></span> <?php echo $_SESSION['p3']; ?>
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion4 ?></span> <?php echo $_SESSION['p4']; ?>
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion5 ?></span> <?php echo $_SESSION['p5']; ?>
