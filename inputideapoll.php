...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ideapoll (id, question) VALUES (%s, %s)",
...
mysql_select_db($database_conn_vote, $conn_vote);
$query_rs_vote = sprintf("SELECT * FROM ideapoll WHERE id = %s", GetSQLValueString($colname_rs_vote, "int"));
